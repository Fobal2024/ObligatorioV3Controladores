...
namespace Obligatorio.Controllers
{
    public class EjerciciosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre")] Ejercicio ejercicio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre")] Ejercicio ejercicio)
        {
            if (id != ejercicio.Id)
            {
                return NotFound();
